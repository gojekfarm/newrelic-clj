# New Relic Clojure - Contributing

New Relic Clojure `[tech.gojek/newrelic-clj]` is an open-source project. 
...
1.  [File an issue][2] 
    ...
    <tech+newrelic-clj@go-jek.com> about future work.

2.  Please use [Clojure Community Style][3].
...
[2]: https://github.com/gojektech/newrelic-clj/issues
